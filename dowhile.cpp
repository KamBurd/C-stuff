...
int main()
{
	...
	do
	{
		...
		case 'D': cost = number * 2.50;
			...
			break;
		case 'e':
		case 'E': cout << " Please come again" << endl;  return 0; //without the statement here, the program wont end when 'e' is pressed, sorry. 
			break;
		default: cout << "Invalid, enter A,B,C,D or E" << endl;// Fill in the code to write a message
...
//Excercise 2: Running a letter besides the aformentioned will show an invalid message previously made with "cout"
//Excercise 3: There are no changes since the "bool" automatically decides if the statement is true or false
